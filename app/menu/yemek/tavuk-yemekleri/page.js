...
import { products } from "../../../../Products/Yemekler/tavuk-yemekleriProducts/index";
import Link from "next/link";
import { FaArrowLeft } from "react-icons/fa6";

export default function TavukYemekleri() {
    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-6 md:mb-8 lg:mb-12">
          ...
          <Link 
            href="/menu/yemek" 
            className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white shadow-sm hover:shadow-md transition-all duration-300 group"
          >
            <FaArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-kaktus-green transition-transform duration-200 group-hover:scale-110" />
          </Link>

          {/* Logo */}
          <Link href="/" className="relative w-40 sm:w-56 md:w-72 lg:w-80 h-20 sm:h-28 md:h-36 lg:h-40">
            <Image
              src="/images/logo.png"
              alt="Kaktus Logo"
              fill
