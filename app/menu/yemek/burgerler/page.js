...
import { products } from "../../../../Products/Yemekler/burgerlerProducts/index";
import Link from "next/link";
import { FaArrowLeft } from "react-icons/fa6";

export default function Burgerler() {
  const [selectedProduct, setSelectedProduct] = useState(null);

  const handleBackdropClick = (e) => {
    if (e.target.id === "modal-backdrop" || e.target.id === "modal-close-btn") {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        {/* Products Grid */}
        <div className="container mx-auto pt-16 sm:pt-20 md:pt-24 lg:pt-32 px-4 sm:px-6 md:px-8 lg:px-10">
