...
export default function Home() {
  ...
  const imageCarouselText = {
    ...
    text1:
      "Tatlı kriziniz mi tuttu? Kaktüs Cafe'nin özenle hazırlanan tatlıları, Adana'da tatlı denince akla gelen ilk durak olmayı başarıyor. Göz alıcı sunumlar, taptaze malzemeler ve her lokmada hissedilen ustalıkla, tatlılarımız sadece damağınızı değil ruhunuzu da şımartıyor.",
    text2:
      "Geleneksel Türk tatlılarından modern lezzetlere uzanan zengin menümüzde her zevke uygun bir seçenek var. İster bir fincan kahve eşliğinde dinlenmek için, ister dost sohbetlerini tatlandırmak için… Kaktüs Cafe'de tatlı yemek bir alışkanlık değil, bir ritüel.",
  };
  const buttonCarouselLeftText = {
    ...
    text1:
      "İtalyan lezzetini Adana'ya taşıyan Kaktüs Cafe pizzaları, incecik hamuru, bol malzemesi ve taş fırın lezzetiyle tam anlamıyla efsane! Taptaze sebzeler, özel soslar ve her lokmada uzayan peynirle bu pizza deneyimi, bildiklerinizi unutturacak.",
    text2:
      "Klasiklerden gurme lezzetlere uzanan geniş pizza menümüz, hem gözünüze hem damağınıza hitap ediyor. İster arkadaşlarla keyifli bir akşam, ister tek başına bir ziyafet… Kaktüs Cafe'nin pizzaları her zaman doğru tercih!",
  };
  const buttonCarouselRightText = {
    ...
    text1:
      "Adana'nın kavurucu sıcağında ferahlatıcı bir mola arıyorsan, Kaktüs Cafe'nin özel soğuk içecek menüsü tam sana göre! Taze meyvelerle hazırlanan smoothie'lerden, buz gibi limonatalara ve aromalı soğuk kahvelere kadar her yudumda serinliği hissedeceksin.",
    text2:
      "Gün boyu enerjini taze tutacak, hem ferahlatan hem de damakta iz bırakan içecek çeşitlerimizle yaz-kış fark etmeden misafirlerimize keyifli bir deneyim sunuyoruz. Soğuk içecek deyince akla gelen ilk yer: Kaktüs Cafe Adana!",
  };
  const videoAnimationRightText = {
    src: "/videos/drone.mp4",
    text: "Kaktüs Cafe'de Her An Bir Deneyim: Lezzet, Tarz ve Keyif Bir Arada",
    text1:
      "Kaktüs Cafe Adana, sadece bir kafe değil; her detayında kalite ve özgünlük hissedilen özel bir yaşam alanı. Güler yüzlü hizmet anlayışımız, şık tasarımımız ve birbirinden lezzetli menülerimizle kendinizi evinizde gibi hissedeceksiniz.",
    text2:
      "Videomuzda göreceğiniz her kare, Kaktüs Cafe'nin sıcak atmosferini, özenle hazırlanan tabaklarını ve konforlu ortamını yansıtıyor. Adana'da keyifli vakit geçirmek isteyen herkesin buluşma noktası olan Kaktüs Cafe'de sizi de ağırlamaktan mutluluk duyarız.",
  };
    ...
    <main>
      ...
      <div className="bg-[#ffffff]">
        ...
        <main className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <a
            className="px-4 flex items-center justify-center mt-2 text-3xl font-bold md:font-normal md:text-5xl text-kaktus-green hover:text-kaktus-green-dark"
            href="/menu"
          >
